        ...
        cards: [
          {
            ...
            text: "\"I'm not here to work with the team, but to take credit for its successes.\"",
          },
          {
            icon: "chat",
            title: "The social club",
            text: "\"I'm not here to work with the team, but to associate with some of its members.\"",
          },
          {
            icon: "trend",
            title: "The stepping stone",
            text: "\"I'm not here to work with the team, but to use it as a steppingstone to better things.\"",
          },
        ],
        example: {
          title: "Hidden agenda",
          lines: [
            "The term \"hidden agenda\" was coined to describe this kind of covert careerism.",
            "It is not honest and it is very destructive to team coherence.",
            "Good teams recognise the fact that in order to build trust, they must uncover their own hidden agendas and expose them to the light of day.",
          ],
        },
        bullets: [
          "Doug — needs empathy for his \"finish and move on\" pressure so the project can find its own rhythm.",
          "Sarah — even without revealing the pregnancy, must signal that something is pulling her away; the team may need to adapt or replace.",
          "Miller — needs to be told (kindly) that he's making people crazy, and why the others are ambivalent — that will engage him and modulate his excesses.",
          "John — needs to open up, respect his team-mates, tell his story once, and then shut up. One is never too old to grow up.",
          "Only by processing every member's wishes and wants — or at minimum acknowledging them — can the team redirect its focus to the shared goal, and make the best gardening supplies website the world ever saw.",
        ],
      },
      {
        heading: "Personal goals inside team goals",
        icon: "target",
        paragraphs: [
        ...
        cards: [
          {
            icon: "person",
            title: "Having a baby",
            text: "A major life event that reasonably outweighs any project.",
          },
          {
            icon: "people",
            title: "Spending more time with family",
            text: "A boundary the team should respect, not resent.",
          },
          {
            icon: "briefcase",
            title: "Seeking a better job after this one",
            text: "Ambition — often quietly driving quality on the way out.",
          },
          {
            icon: "gradcap",
            title: "Going back to school and getting that degree",
            text: "A long-term investment that shapes today's choices.",
          },
        ],
        example: {
          title: "…or they can be a shade less edifying",
          lines: [
        ...
        bullets: [
          "Whatever the personal goals — we need to know what they are, and to deal with them, or at least acknowledge them, as a team, perhaps even to make them corollary team goals.",
          "The bond — when we know our fellow team members want us to achieve what we ourselves want, that is a terrific bond between members.",
          "The sooner the better — the sooner we know one another's personal needs and hopes, the better for the team.",
          "Not a precondition — this doesn't mean these personal needs have to be completely met first before true teaming can get underway.",
          "But do it early — acknowledging and addressing these needs as a group, early on, can help prevent our \"selfish\" desires from sinking the team effort.",
        ],
      },
      {
        heading: "Ethics",
