...
const modules: CourseModule[] = [
  ...
  {
    id: "m2",
    name: "Planning, Change & Innovation",
    icon: "design",
    activities: 4,
    units: [
  ...
  {
    id: "m4",
    name: "Leading Teams & Performance",
    icon: "people",
    activities: 4,
    units: [
  ...
  {
    id: "m5",
    name: "Relationships, Diversity & Knowledge",
    icon: "chat",
    activities: 3,
    units: [
  ...
  {
    id: "m6",
    name: "Electives — People & Compliance",
    icon: "briefcase",
    activities: 6,
    units: [
...
const poeSections: { heading: string; icon: string; multi?: boolean; items: { id: string; label: string }[] }[] = [
  ...
  },
  {
    ...
    multi: true,
    items: [
      { id: "gm-fa01", label: "GM-M1-FA01 — Leadership Foundations (submitted & assessed)" },
      { id: "gm-fa02", label: "GM-M2-FA02 — Planning, Change & Innovation (submitted & assessed)" },
      { id: "gm-fa03", label: "GM-M3-FA03 — Finance, Analysis & Risk (submitted & assessed)" },
      { id: "gm-fa04", label: "GM-M4-FA04 — Leading Teams & Performance (submitted & assessed)" },
      { id: "gm-fa05", label: "GM-M5-FA05 — Relationships, Diversity & Knowledge (submitted & assessed)" },
      { id: "gm-fa06", label: "GM-M6-FA06 — Electives: People & Compliance (submitted & assessed)" },
    ],
  },
  {
