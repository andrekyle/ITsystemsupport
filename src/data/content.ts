        ...
        questions: [
          {
            ...
            options: [
              "Writing business reports for project stakeholders",
              "Working effectively as part of a project team: knowing what is expected of a team member, contributing to the team's coherence and spirit, and building sound relations",
              "Managing a project budget and timeline",
              "Installing and configuring project management software",
            ],
            answer: 1,
            explain: "US 10135 covers working effectively as part of a project team — expectations of a team member, contributing to coherence and spirit, and building sound relations with team members and stakeholders.",
          },
          {
            q: "Why does competence in US 10135 underpin your daily work in an IT systems support environment?",
            options: [
              "Because IT staff mostly work alone",
              "Because almost everything is delivered by teams — a service desk shift, a workstation rollout, a system upgrade project",
              "Because it replaces the need for technical skills",
              "Because it is the only unit standard in the qualification",
            ],
            answer: 1,
            explain: "In IT systems support almost everything is delivered by teams — service desk shifts, rollouts and upgrade projects — so teamwork competence underpins daily work.",
          },
          {
            q: "What does the alignment index at the front of the learner manual map?",
            options: [
              "The training dates for each module",
              "Each section of the learner manual to the outcomes you must be proved competent in",
              "The names of the facilitators for each session",
              "The price of each learner manual",
            ],
            answer: 1,
            explain: "The alignment index maps each manual section (and its pages) to the outcomes you must be proved competent in, so you can navigate the manual and check your evidence section by section.",
          },
          {
            q: "How is your knowledge of each manual section assessed?",
            options: [
              "With a practical workstation build",
              "With the questions in the Question Sessions that follow each section",
              "With an oral exam by the moderator",
              "It is not assessed at all",
            ],
            answer: 1,
            explain: "Each content section is followed by a Question Session — 'Your knowledge of this section is assessed with the questions.'",
          },
          {
            q: "What does the section on criteria for working as a member of a team cover?",
            options: [
              "The required understanding that team members must harbour to work effectively and autonomously as part of the team",
              "The company's leave policy",
              "How to write a curriculum vitae",
              "Server administration procedures",
            ],
            answer: 0,
            explain: "That section covers the required understanding team members must harbour to work effectively and autonomously as part of the team.",
          },
          {
            q: "What does the section on contribution to team coherence, image and spirit cover?",
            options: [
              "How to design a team logo",
              "The different contributions members of a team have to make to ensure that all the members are happy and compliant with the team's efforts in reaching their goals",
              "Salary negotiations for team members",
              "The history of teamwork theory",
            ],
            answer: 1,
            explain: "It covers the contributions members must make so all members are happy and compliant with the team's efforts and endeavours in reaching their goals.",
          },
          {
            q: "What does the section on building relations between team members and stakeholders explain?",
            options: [
              "How to avoid speaking to stakeholders",
              "The importance of relations between team members and the stakeholders of an organisation or entity to ensure the required outcome is reached",
              "How to replace stakeholders with contractors",
              "Legal contracts between companies",
            ],
            answer: 1,
            explain: "It explains the importance of relations between the team and the organisation's stakeholders to ensure the required outcome is reached.",
          },
          {
            q: "When do you complete the self assessment?",
            options: [
              "Before the first session starts",
              "Once you have completed all the questions after being facilitated",
              "Only if the facilitator is absent",
              "After certification",
            ],
            answer: 1,
            explain: "The self assessment is completed once you have completed all the questions after being facilitated, to check the progress you have made.",
          },
          {
            q: "In the self assessment, what do you do for areas where you feel competent?",
            options: [
              "Leave them blank",
              "Tick the blocks",
              "Cross them out",
              "Write a full-page essay on each",
            ],
            answer: 1,
            explain: "If you feel that you are competent in the areas mentioned, you may tick the blocks.",
          },
          {
            q: "What must you do if you feel you require additional knowledge in an area?",
            options: [
              "Keep quiet and hope it is not assessed",
              "Indicate it in the block, show it to your facilitator and make the necessary arrangements to assist you to become competent",
              "Skip that section of the manual",
              "Ask another learner to complete the assessment for you",
            ],
            answer: 1,
            explain: "You indicate it in the block, show this to your facilitator and make the necessary arrangements to assist you to become competent.",
          },
        ],
      },
      {
