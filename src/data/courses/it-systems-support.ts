...
export const IT_SYSTEMS_SUPPORT = {
  id: "itss",
  label: "IT Systems Support (48573)",
  blurb:
    "A QCTO/SETA-aligned qualification covering business practice, client-server networking, network architecture, LAN design, server administration and database access.",
  meta,
  modules,
  programmeAbout,
  programmePurpose,
