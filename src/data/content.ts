    ...
    exercises: [
      {
        ...
        scenario: [
          ...
          "Groups — The class of twelve splits into three consulting teams of four. Each team works independently on its own strategy; at the end the three strategies are compared, and feedback is taken from the groups.",
          "Step 1 — Form the team and agree the roles. Everyone must agree on appropriate roles and everyone must be satisfied in their role: a leader who sets the base agenda, facilitates the discussion and monitors progress, plus supporting roles from the lesson — initiator, recorder, devil's advocate/skeptic, optimist, timekeeper, gate keeper and summarizer. With four members, combine roles — for instance a recorder/summarizer.",
